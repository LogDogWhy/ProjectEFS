...
namespace Content.Shared.GG.DayCycle.Components;

/// <summary>
/// Stores all the necessary data for the day and night cycle system to work.
/// </summary>
[RegisterComponent, NetworkedComponent, AutoGenerateComponentState, Access(typeof(GGSharedDayCycleSystem))]
public sealed partial class GGDayCycleComponent : Component
{
    [ViewVariables]
    ...
    [ViewVariables]
    public ProtoId<GGDayCyclePeriodPrototype> CurrentPeriod => CurrentTimeEntry.Period;
...
public readonly partial record struct DayCycleEntry()
{
    ...
    [DataField]
    public ProtoId<GGDayCyclePeriodPrototype> Period { get; init; } = "Day";
}
