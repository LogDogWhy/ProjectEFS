...
public sealed class GGAddTimeEntryCommand : LocalizedCommands
{
    private const string Name = "gg-addtimeentry";
    ...
    public override void Execute(IConsoleShell shell, string argStr, string[] args)
    {
        ...
        if (!prototypeManager.TryIndex<GGDayCyclePeriodPrototype>(args[3], out var prototype))
        {
    ...
    public override CompletionResult GetCompletion(IConsoleShell shell, string[] args)
    {
        return args.Length switch
        {
            ...
            4 => CompletionResult.FromOptions(CompletionHelper.PrototypeIDs<GGDayCyclePeriodPrototype>()),
