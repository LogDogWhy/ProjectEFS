...
public sealed partial class GGDayCycleSystem : GGSharedDayCycleSystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<GGDayCycleComponent, MapInitEvent>(OnMapInitDayCycle);
    }

    private void OnMapInitDayCycle(Entity<GGDayCycleComponent> dayCycle, ref MapInitEvent args)
    {
        Init(dayCycle);
    ...
    public override void Update(float frameTime)
    {
        ...
        var dayCycleQuery = EntityQueryEnumerator<GGDayCycleComponent, MapLightComponent>();
        while (dayCycleQuery.MoveNext(out var uid, out var dayCycle, out var mapLight))
        {
            var entity = new Entity<GGDayCycleComponent, MapLightComponent>(uid, dayCycle, mapLight);
    ...
    public void Init(Entity<GGDayCycleComponent> dayCycle)
    {
    ...
    public void AddTimeEntry(Entity<GGDayCycleComponent> dayCycle, DayCycleEntry entry)
    {
        dayCycle.Comp.TimeEntries.Add(entry);
        Dirty(dayCycle);
    }

    public void SetTimeEntry(Entity<GGDayCycleComponent> dayCycle, int nextEntry)
    {
    ...
    private Color GetCurrentColor(Entity<GGDayCycleComponent> dayCycle, double totalSeconds)
    {
    ...
    private float GetTimeScale(Entity<GGDayCycleComponent> dayCycle, double totalSeconds)
    {
