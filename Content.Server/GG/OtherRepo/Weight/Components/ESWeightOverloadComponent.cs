...
public sealed partial class ESWeightOverloadComponent : Component
{
    ...
    [DataField]
    public ProtoId<AlertCategoryPrototype> OverloadAlertCategory = "ESOverload";

    [DataField]
    public ProtoId<AlertPrototype> SlightOverloadAlert = "ESSlightOverload";

    [DataField]
    public ProtoId<AlertPrototype> OverloadAlert = "ESOverload";

    [DataField]
    public ProtoId<AlertPrototype> SevereOverloadAlert = "ESSevereOverload";
