...
using Content.Server.VXS.Mortar;
using Content.Shared.VXS.Mortar;
...
namespace Content.Server.VXS.Mortar;
...
public sealed class MortarEui : BaseEui
{
    ...
    public override void HandleMessage(EuiMessageBase msg)
    {
        ...
        if(comp != null)
            sysMan.GetEntitySystem<ExplosionSystem>().QueueExplosion(request.Epicenter, comp.Type, comp.TotalIntensity, comp.Slope, comp.MaxTileIntensity);
