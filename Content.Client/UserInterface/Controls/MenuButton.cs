...
public sealed class MenuButton : ContainerButton
{
    ...
    private static readonly Color ColorNormal = Color.FromHex("#38761d");
    private static readonly Color ColorRedNormal = Color.FromHex("#FEFEFE");
    private static readonly Color ColorHovered = Color.FromHex("#5f914a");
    private static readonly Color ColorRedHovered = Color.FromHex("#FFFFFF");
    private static readonly Color ColorPressed = Color.FromHex("#ebf1e8");
